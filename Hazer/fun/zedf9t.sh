...
# SparkFun u-blox GNSS library for Arduino still uses the UBX-CFG-TP5 message.
...
exec coreable gpstool \
    ...
    -A '\xb5\x62\x06\x31'"$(ubxval -2 32)$(ubxval -1 0)$(ubxval -1 1)"'\x00\x00'"$(ubxval -2 0)$(ubxval -2 0)$(ubxval -4 1000000)$(ubxval -4 1000000)$(ubxval -4 100000)$(ubxval -4 100000)$(ubxval -4 0)$(ubxval -4 0x2077)"
    < /dev/null 1> /dev/null
