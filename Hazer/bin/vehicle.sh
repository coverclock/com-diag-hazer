...
coreable gpstool \
	...
	-U '\xb5\x62\x06\x01\x03\x00\x01\x20\x01' \
	-U '\xb5\x62\x06\x01\x03\x00\x01\x21\x01' \
	-U '\xb5\x62\x06\x01\x03\x00\x01\x22\x01' \
	-U '\xb5\x62\x06\x01\x03\x00\x0d\x01\x01' \
	-U '\xb5\x62\x06\x01\x03\x00\x0d\x03\x01' \
