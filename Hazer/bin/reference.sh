...
# Configure and monitor the U-blox ZED-UBX-F9T as a high precision
# time and frequency reference in "survey-in" mode, with TP1
# emitting a 1PPS digital signal, and TP2 emitting a 10MHz square
# wave. This is part of the "Metronome" sub-project, and is based
# on the fun/zedf9t-configure.sh and fun/zedf9t.sh scripts.
# (Tested but not verified with an oscilloscope; the scripts on
# which is was based were verified, however.)
...
# UBX-CFG-VALSET [12] V1 RAM Continue 0x00 CFG-TP-DUTY_TP1 10.0 (%)
# UBX-CFG-VALSET [12] V1 RAM Continue 0x00 CFG-TP-DUTY_LOCK_TP1 10.0 (%)
...
# UBX-CFG-VALSET [12] V1 RAM Continue 0x00 CFG-TP-DUTY_TP2 50.0 (%)
# UBX-CFG-VALSET [12] V1 RAM Continue 0x00 CFG-TP-DUTY_LOCK_TP2 50.0 (%)
