...
exec coreable gpstool \
    ...
    -U '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x09\x00\x03\x40'"${CFG_TMODE_LAT}" \
    -U '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x0c\x00\x03\x20'"${CFG_TMODE_LATHP}" \
    -U '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x0a\x00\x03\x40'"${CFG_TMODE_LON}" \
    -U '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x0d\x00\x03\x20'"${CFG_TMODE_LONHP}" \
    -U '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x0b\x00\x03\x40'"${CFG_TMODE_HEIGHT}" \
    -U '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x0e\x00\x03\x20'"${CFG_TMODE_HEIGHTHP}" \
    -U '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x0f\x00\x03\x40'"${CFG_TMODE_FIXED_POS_ACC}" \
