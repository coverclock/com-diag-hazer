...
exec coreable gpstool \
    ...
    -A '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x09\x00\x03\x40'"${LAT}" \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x0c\x00\x03\x20'"${LATHP}" \
    -A '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x0a\x00\x03\x40'"${LON}" \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x0d\x00\x03\x20'"${LONHP}" \
    -A '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x0b\x00\x03\x40'"${HEIGHT}" \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x0e\x00\x03\x20'"${HEIGHTHP}" \
    -A '\xb5\x62\x06\x8a\x0c\x00\x00\x01\x00\x00\x0f\x00\x03\x40'"${FIXED_POS_ACC}" \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x01\x00\x03\x20\x02' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x02\x00\x03\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\xc0\x02\x91\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x61\x03\x91\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x66\x03\x91\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x6b\x03\x91\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x70\x03\x91\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x06\x03\x91\x20\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x04\x00\x77\x10\x00' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x04\x00\x78\x10\x01' \
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x8b\x00\x91\x20\x01' \
