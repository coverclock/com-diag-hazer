...
log -N ${PROGRAM} -i CFG_TMODE_LAT="\"${CFG_TMODE_LAT}\"" 2>> ${LOG}/${PROGRAM}.err
log -N ${PROGRAM} -i CFG_TMODE_LATHP="\"${CFG_TMODE_LATHP}\"" 2>> ${LOG}/${PROGRAM}.err
log -N ${PROGRAM} -i CFG_TMODE_LON="\"${CFG_TMODE_LON}\"" 2>> ${LOG}/${PROGRAM}.err
log -N ${PROGRAM} -i CFG_TMODE_LONHP="\"${CFG_TMODE_LONHP}\"" 2>> ${LOG}/${PROGRAM}.err
log -N ${PROGRAM} -i CFG_TMODE_HEIGHT="\"${CFG_TMODE_HEIGHT}\"" 2>> ${LOG}/${PROGRAM}.err
log -N ${PROGRAM} -i CFG_TMODE_HEIGHTHP="\"${CFG_TMODE_HEIGHTHP}\"" 2>> ${LOG}/${PROGRAM}.err
