...
# Configure and run the U-blox ZED-ABX-F9P as a uncorrected independent
...
# UBX-CFG-VALSET [9] V0 RAM 0 0 CFG-AART1-ENABLED 0
# UBX-CFG-VALSET [9] V0 RAM 0 0 CFG-AART2-ENABLED 0
# UBX-CFG-VALSET [9] V0 RAM 0 0 CFG-ASBINPROT-RTCM3X 0
# UBX-CFG-VALSET [9] V0 RAM 0 0 CFG-ASBOUTPROT-RTCM3X 0
# UBX-CFG-VALSET [9] V0 RAM 0 0 CFG-MSGOUT-ABX_RXM_RTCM_USB 0
...
exec coreable gpstool \
    ...
    -A '\xb5\x62\x06\x8a\x09\x00\x00\x01\x00\x00\x6b\x02\x91\x20\x00' \
    -A '' \
    < /dev/null 1> /dev/null
...
#    -A '\xb5\x62\x06\x01\x03\x00\x0a\x36\xf0' \
