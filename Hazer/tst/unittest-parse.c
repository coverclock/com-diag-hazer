...
#define UNITTEST_PARSE_TALKER_SYSTEM(_STRING_, _TALKER_, _SYSTEM_) \
    do { \
        ...
        assert((_TALKER_ == HAZER_TALKER_TOTAL) || (strncmp(_STRING_, HAZER_TALKER_NAME[_TALKER_], strlen(HAZER_TALKER_NAME[_TALKER_])) == 0)); \
    } while (0)
    ...
    UNITTEST_PARSE_TALKER_SYSTEM("GQ", HAZER_TALKER_QZSS2, HAZER_SYSTEM_QZSS);
    UNITTEST_PARSE_TALKER_SYSTEM("II", HAZER_TALKER_INSTRUMENTATION, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("IN", HAZER_TALKER_NAVIGATION, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("LC", HAZER_TALKER_LORANC, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PAIR", HAZER_TALKER_PAIR, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PAIR001", HAZER_TALKER_PAIR, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PAIR010", HAZER_TALKER_PAIR, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PAIR020", HAZER_TALKER_PAIR, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRM", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMB", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMC", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMC1", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRME", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMF", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMH", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMI", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMM", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMO", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMT", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMV", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMW", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PGRMZ", HAZER_TALKER_PGRM, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PMTK", HAZER_TALKER_PMTK, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PMTK220", HAZER_TALKER_PMTK, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PMTK251", HAZER_TALKER_PMTK, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PMTK314", HAZER_TALKER_PMTK, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PMTK605", HAZER_TALKER_PMTK, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF140", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF150", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF151", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF152", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF154", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRF155", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PSRFEPE", HAZER_TALKER_PSRF, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PUBX", HAZER_TALKER_PUBX, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PUBX,00", HAZER_TALKER_PUBX, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PUBX,03", HAZER_TALKER_PUBX, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("PUBX,04", HAZER_TALKER_PUBX, HAZER_SYSTEM_TOTAL);
    UNITTEST_PARSE_TALKER_SYSTEM("QZ", HAZER_TALKER_QZSS, HAZER_SYSTEM_QZSS);
