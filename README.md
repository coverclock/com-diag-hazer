...
* Tesoro (OSM support),
* Metronome (precision time and frequency support), and
...
* Garmin GLO 2 (unknown, Bluetooth, N/A, rfcomm, 10Hz) [15] [21] [22]    
...
[21] Rumored to differ from the original GLO only by its increased battery life (but see [22]).    
[22] Supposed to receive both GPS and GLONASS but neither of my two units do.    
